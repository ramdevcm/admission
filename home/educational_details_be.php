        ...
        <div class="col-lg-9">
            <div class="panel panel-default">
                <div class="panel-heading main-color-bg">
                    <h3 class="panel-title"> <b>Provide Diploma & Post Graduates Educational Information</b> </h3>
                </div>
            ...
            <!-- Joint Entry Exams For science courses -->
            <div class="panel panel-default">
                <div class="panel-heading main-color-bg">
                    <h3 class="panel-title"> <b>Joint Entry Exams(JEE-Main) For science & Engineering courses</b> </h3>
                </div>
                <div class="panel-body">
                    <div class="col-lg-12">
                        <div class="row">
            ...
            <div class="panel panel-default">
                <div class="panel-heading main-color-bg">
                    <h3 class="panel-title"> <b>Department Applied For</b> </h3>
                </div>
                <div class="panel-body">
                    <div class="col-lg-12">
                        <div class="row">
                            <p style="color:#BD0006;"> Department Applied For (Labour Studies, Languages, Business, Science & Technology) </p>
                            <div class="row">
